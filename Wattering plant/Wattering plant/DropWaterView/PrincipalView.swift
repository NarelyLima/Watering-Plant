...
//    @State var isSucess: Bool = false
    ...
    @State var someNode = SKNode()
    let audioPlayer2 = SKAction.playSoundFileNamed("DoneSound", waitForCompletion: false)
    ...
    var body: some View {
        ZStack(alignment: .bottom) {
            ...
            .ignoresSafeArea()
            VStack {
                Text("Boa noite, user! Plantinha está sem ser regada há 2 dias.")
                    .padding()
